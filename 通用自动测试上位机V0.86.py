...
# -----------------------------------事件更新计数---------------------------------------
    ...
    def event_power_off(self,command='all'):
        ...
        if str(self.config_power_model)=='1':
            ...
            #         power_serials = serial.Serial(serial_com, 57600)
            #     except Exception as e:
            #         print('电源关闭失败{} {}'.format(serial_com,e))
            #         return
    ...
    def threading_receive_data(self,thread_num,decode_hex=None):
        ...
        # sum_check_rule1 = None
        # sum_check_rule2 = None
        # sum_check_rule3 = None
        # if self.config_sum_check0 is not None:
        #     try:
        #         split_list = split_plus(self.config_sum_check0)
        #         split_list = [int(num) for num in split_list]
        #         if len(split_list)==3:
        #             sum_check_rule1 = split_list
        #         else:
        #             sum_check_rule1 = None
        #     except Exception as e:
        #         self.config_sum_check0 = None
        ...
        # if self.config_sum_check1 is not None:
        #     try:
        #         split_list = split_plus(self.config_sum_check1)
        #         split_list = [int(num) for num in split_list]
        #         if len(split_list)==3:
        #             sum_check_rule2 = split_list
        #         else:
        #             sum_check_rule2 = None
        #     except Exception as e:
        #         self.config_sum_check1 = None
        #         sum_check_rule2 = None
        #         self.debug_list_2.append('{} 获取校验和1错误:{}'.format(self.normal_time,e))
        # if self.config_sum_check2 is not None:
        #     try:
        #         split_list = split_plus(self.config_sum_check2)
        #         split_list = [int(num) for num in split_list]
        #         if len(split_list)==3:
        #             sum_check_rule3 = split_list
        #         else:
        #             sum_check_rule3 = None
        #     except Exception as e:
        #         self.config_sum_check2 = None
        ...
        # for sum_check in sum_check_list:
        #     if sum_check is not None:
        #         config_sum_check_list.append(sum_check)
        ...
        # print('len_default_sate_list:{}'.format(len(self.default_sate_list)))
        ...
        if not isinstance(decode_hex,bytes):
            ...
            #         e = e
            # if not serials:
            #     self.debug_list_2.append('{} tab_{}:第五次开启串口失败,com:{},线程关闭 {}'.format(self.normal_time,thread_num,com,e))
            #     self.threading_list_flag[thread_num] = False
            #     self.show_message_automatic_list.append('{} tab_{} com:{} 开启失败'.format(self.normal_time,thread_num,com))
        ...
        while self.threading_test_flag & self.threading_list_flag[thread_num]:
            ...
            if hex_length_result:
                ...
                if frame.startswith(decode_rule_header) & next_frame.startswith(decode_rule_header): 
                    ...
                    receive_data_hz,sum_check_result = decode_hex_frame_list(frame,decode_rule_list,decode_save_list,decode_para_list,decode_sort_list,decode_edia_list,self.config_sum_check)
                    ...
                    if self.flag_sate_receive:
                        ...
                        for num in range(6):
                            if (self.settings.sate_append_sate==True)&(self.constants.struct_sate.list_sate_flag[num+2]==True):
                                ...
                                # print(self.constants.struct_sate.list_sate_msg[i+2])
                            # if self.settings.sate_clear_msg:
                            #     # self.list_sate_KSXT = self.default_sate_list
                                # self.constants.struct_sate.clear_sate_list(i+2)
